...
call :export run_once > "%temp%\MAS\Run_Once.xml"
...
copy /y /b "%temp%\MAS\2.." + "%temp%\MAS\Online_KMS_Activation.cmd" "%windir%\Online_KMS_Activation_Script\Online_KMS_Activation_Script-Run_Once.cmd" %nul%
schtasks /create /tn "Online_KMS_Activation_Script-Run_Once" /ru "SYSTEM" /xml "%temp%\MAS\Run_Once.xml" %nul%
